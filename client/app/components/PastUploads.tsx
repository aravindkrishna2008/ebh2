      ...
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center gap-4 mb-12">
          ...
          <div>
            ...
            <p className="text-xs uppercase tracking-widest opacity-40 font-medium mt-1">
              Your Recordings
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-4">
          {uploads.map((upload) => (
            <div
              key={upload.id}
              className="bg-[#EAE8E0] p-4 md:p-6 rounded-2xl flex items-center justify-between group hover:bg-white hover:shadow-xl hover:shadow-black/5 transition-all duration-300 cursor-pointer"
            >
              <div className="flex items-center gap-4 md:gap-6">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1.5">
                    ...
                    <span className="text-[10px] opacity-40 font-mono font-medium">
                      {upload.duration}
                    </span>
                  </div>
                  <div className="font-bold text-lg leading-none group-hover:text-[#F45B69] transition-colors">
                    Recording {upload.id}
                  </div>
                </div>
              </div>
              ...
              <div className="text-right hidden md:block">
                ...
                <div className="text-xs opacity-40 font-medium tracking-wider">
                  {upload.time}
                </div>
              </div>
            </div>
